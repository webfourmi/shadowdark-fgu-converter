...
const GEAR_TRANSLATIONS = {
  ...
  // Équipement courant
  "Backpack": "Sac à dos",
  "Ball bearing": "Billes de métal",
  "Candle ,3": "Bougie (3)",
  "Candle": "Bougie (3)",
  "Charcoal, jar": "Charbon",
  "Flash seed": "Graine flash",
  "Glow paste": "Pâte fluorescente",
  "Torch": "Torche",
  "Lantern": "Lanterne",
  "Lantern hook": "Crochet de lanterne",
  "Oil, flask": "Huile, flasque",
  "Holy water, flask": "Eau bénite, flasque",
  "Flask or bottle": "Flasque ou bouteille",
  "Miner's putty": "Mastic de mineur",
  "Net": "Filet",
  ...
  "Mirror": "Miroir",
  "Pole, 10'": "Perche, 3 m",
  "Rope, morzo silk": "Corde de soie",
  "Sack": "Sac",
  "Tallow, jar": "Suif (jarre)",
  "Waterskin": "Outre",
  "Bedroll": "Couverture de voyage",
  "Thieves' tools": "Outils de voleur",
  "Holy symbol": "Symbole sacré",
  "Spellbook": "Grimoire",
  "Traveler's lamp": "Lampe du voyageur",
  "Ink": "Encre",
  "Quill": "Plume",
  "Parchment": "Parchemin",
  "Chalk": "Craie"
